...
@Provider
public class AnalysisNotFoundExceptionMapper implements ExceptionMapper<AnalysisNotFoundException> {

    @Override
    public Response toResponse(AnalysisNotFoundException exception) {
